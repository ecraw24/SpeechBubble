...
__all__ = [
    'SREPropertyStringChange', 'SpeechAudioVolume',
    'SAFT12kHz16BitMono', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVEStartInputStream', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_START_SR_STREAM',
    'ISpeechRecognizer', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SMSAMMHandle', 'eLEXTYPE_PRIVATE11',
    'SpStreamFormatConverter', 'SPLO_STATIC',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SWFEExtraData',
    'SpeechRecognitionType', 'IStream', 'DISPID_SRAudioInputStream',
    'DISPID_SpeechLexiconWord', 'SPBO_TIME_UNITS',
    'SpeechGrammarTagUnlimitedDictation', 'SPVPRI_NORMAL',
    'ISpObjectToken', 'ISpeechResourceLoader', 'DISPID_SPPChildren',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRGetPropertyNumber',
    'WAVEFORMATEX', 'SLTUser', 'SpeechTokenKeyAttributes',
    'DISPID_SPRsCount', 'SAFT22kHz8BitMono', 'SPRS_ACTIVE',
    'DISPID_SPIReplacements', 'SpeechTokenIdUserLexicon',
    'ISpMMSysAudio', 'SPINTERFERENCE_TOOQUIET',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRGIsPronounceable',
    'SGRSTTDictation', 'SpeechAudioFormatType',
    'DISPID_SPEAudioSizeBytes', 'SRSActiveAlways',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_RESERVED4',
    'eLEXTYPE_RESERVED8', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVGetAudioInputs', 'SDTPronunciation',
    'eLEXTYPE_PRIVATE20', 'SPRULESTATE', 'SP_VISEME_13',
    'SVSFlagsAsync', 'DISPID_SRDisplayUI', 'ISpRecoResult',
    'SPEI_SR_BOOKMARK', 'SWPKnownWordPronounceable', 'SRSInactive',
    'SAFTNonStandardFormat', 'DISPID_SpeechAudio',
    'SAFT12kHz16BitStereo', 'SRESoundEnd', 'SPEI_END_INPUT_STREAM',
    'SpeechMicTraining', 'SpeechPropertyResourceUsage',
    'DISPID_SRGDictationLoad', 'SAFT12kHz8BitMono',
    'ISpeechPhraseElements', 'SAFT22kHz16BitStereo',
    'ISpeechObjectTokenCategory', 'DISPID_SpeechPhraseAlternates',
    'ISpeechWaveFormatEx', 'eLEXTYPE_PRIVATE5', 'SPPROPERTYINFO',
    'SWPUnknownWordUnpronounceable', 'SAFTCCITT_uLaw_44kHzMono',
    'SRAImport', 'SPRST_ACTIVE_ALWAYS', 'SDTAll',
    ...
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRRSetTextFeedback',
    'DISPID_SLWWord', 'DISPID_SASetState', 'SPEI_UNDEFINED',
    'DISPID_SAEventHandle', 'ISpResourceManager',
    'SpPhraseInfoBuilder', 'SPPHRASEELEMENT', 'SAFT32kHz8BitMono',
    'SSFMOpenReadWrite', 'SPEI_RESERVED3', 'SPEI_RESERVED1',
    'SpeechTokenKeyUI', 'DISPID_SpeechObjectToken',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SABufferNotifySize',
    'DISPID_SGRSTType', 'DISPID_SVSRunningState', 'SASClosed',
    'DISPID_SPIAudioStreamPosition', '_ISpeechVoiceEvents',
    'SDTAudio', 'SRSInactiveWithPurge', 'SPPS_Verb',
    'IInternetSecurityMgrSite', 'ISequentialStream',
    'DISPID_SRCEStartStream', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRCRecognizer', 'SPGRAMMARSTATE', 'SPSLMA',
    'DISPID_SRGetFormat', 'DISPID_SVVoice', 'DISPID_SPAsItem',
    ...
    'DISPID_SPPsCount', 'SPFM_CREATE', 'SPPS_RESERVED2',
    'DISPID_SRIsUISupported', 'DISPID_SPPNumberOfElements',
    'SPEI_VOICE_CHANGE', 'SpeechDiscardType',
    'DISPID_SVAlertBoundary', 'SPCT_SLEEP', 'DISPID_SVSpeak',
    'DISPID_SpeechMMSysAudio', 'SPDKL_DefaultLocation', 'SVP_14',
    'DISPID_SRCResume', 'SpeechVoiceSkipTypeSentence',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRRPhraseInfo', 'SVP_7',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechPhraseAlternate',
    'DISPID_SpeechObjectTokenCategory', 'SAFT8kHz16BitMono',
    'SPRECOSTATE', 'SPGS_EXCLUSIVE', 'SPEI_MAX_TTS',
    'DISPID_SVWaitUntilDone', 'ISpeechObjectTokens',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SWFEChannels',
    'DISPID_SAStatus', 'ISpeechLexiconPronunciations',
    'ISpGrammarBuilder', 'eLEXTYPE_PRIVATE10', 'SGRSTTWord', 'SVP_19',
    'SPXRO_SML', 'SpeechVisemeType', 'SpeechVisemeFeature',
    'SpeechVoicePriority', 'SPSVerb', 'ISpeechPhraseRule',
    'DISPID_SpeechLexicon', 'DISPID_SRSClsidEngine',
    'SGDSActiveWithAutoPause',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SECFIgnoreKanaType', 'DISPID_SRCESoundEnd',
    'DISPID_SGRAttributes', 'DISPID_SVSLastResult',
    'SAFTADPCM_22kHzStereo', 'SDKLCurrentUser', 'SRAInterpreter',
    '_ISpeechRecoContextEvents', 'SpeechStreamFileMode',
    'eLEXTYPE_PRIVATE4', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRRRecoContext', 'SVP_1', 'DISPID_SpeechPhraseProperties',
    'SPAO_NONE', 'SLTApp', 'SPWAVEFORMATTYPE', 'SDTProperty',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPEsItem',
    'ISpeechRecognizerStatus', 'DISPID_SVAudioOutputStream',
    'DISPID_SOTCGetDataKey', 'ISpeechPhraseInfoBuilder',
    'SP_VISEME_8', 'DISPID_SGRSTNextState',
    'SpeechStreamSeekPositionType', 'ISpPhrase', 'SPSFunction',
    'Speech_StreamPos_Asap', 'ISpeechObjectToken',
    'SPXMLRESULTOPTIONS', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SPIGetText',
    'Speech_Max_Pron_Length', 'DISPID_SOTGetAttribute',
    'DISPID_SLGetWords', 'DISPID_SDKDeleteKey',
    'ISpeechRecoResultTimes', 'SREPhraseStart', 'SPSHT_NotOverriden',
    'DISPID_SPCPhoneToId', 'SpObjectTokenCategory', 'SPSHT_EMAIL',
    'IInternetSecurityManager', 'DISPID_SGRsCommit',
    'Speech_StreamPos_RealTime', 'DISPID_SDKDeleteValue',
    'SP_VISEME_4', 'DISPID_SPRulesCount', 'DISPID_SVSLastBookmark',
    'DISPID_SRCERequestUI', 'SAFT44kHz16BitMono', 'SPEI_MIN_TTS',
    'DISPID_SRRecognizer', 'SP_VISEME_9', 'eLEXTYPE_PRIVATE6',
    'SRARoot', 'DISPID_SRCEHypothesis', 'SPAUDIOBUFFERINFO',
    'SpeechGrammarWordType', 'ISpeechGrammarRuleState',
    'eLEXTYPE_RESERVED10', 'SREStateChange', 'SREBookmark',
    'DISPID_SVEventInterests', 'DISPID_SOTId', 'SPEI_ADAPTATION',
    'DISPID_SPPValue', 'ISpeechVoiceStatus', 'SpAudioFormat',
    'SVSFNLPSpeakPunc', 'SPAS_RUN', 'DISPID_SRCRetainedAudio',
    'SGPronounciation', 'SRADefaultToActive', 'SSSPTRelativeToEnd',
    'SVF_Emphasis', 'SAFTCCITT_ALaw_11kHzStereo',
    'eLEXTYPE_PRIVATE17', 'DISPID_SPPEngineConfidence', 'SVP_15',
    'DISPID_SLPType', 'SVEAllEvents', 'SPEI_WORD_BOUNDARY',
    'ISpeechPhraseProperty',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPARecoResult',
    'SAFTADPCM_22kHzMono', 'SGLexical', 'DISPID_SVEStreamStart',
    'SpMMAudioEnum', 'DISPID_SABIBufferSize', 'DISPID_SpeechDataKey',
    'SpeechFormatType', 'ISpeechPhraseInfo',
    'DISPID_SGRSAddSpecialTransition', 'SPWT_DISPLAY',
    'DISPID_SVSVisemeId', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechVoiceStatus', 'SVEPhoneme', 'SRERequestUI',
    'DISPID_SPPs_NewEnum', 'DISPID_SOTDataKey', 'DISPID_SVStatus',
    'SREPrivate', 'SVSFDefault', 'SAFTGSM610_8kHzMono', 'ISpStream',
    ...
    'DISPID_SpeechPhoneConverter', 'SP_VISEME_10',
    'ISpeechGrammarRules', 'DISPID_SpeechRecoContext',
    'SPPHRASEREPLACEMENT', 'DISPID_SRCreateRecoContext',
    'SPEVENTSOURCEINFO', 'DISPID_SRGReset', 'SPPS_Unknown',
    'SPRECORESULTTIMES', 'DISPID_SRRTTickCount',
    'SAFTADPCM_11kHzMono', 'DISPID_SLPs_NewEnum',
    'SPINTERFERENCE_TOOLOUD', 'SpResourceManager', 'SINone',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SOTsItem',
    'eLEXTYPE_PRIVATE19', 'SAFT24kHz8BitStereo', 'eLEXTYPE_USER',
    'SPSInterjection', 'SVP_10', 'SAFT22kHz16BitMono',
    'DISPID_SpeechLexiconWords', 'DISPID_SFSOpen',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SABIEventBias',
    'SpMMAudioIn', 'tagSTATSTG', 'DISPID_SRRGetXMLResult',
    'SREAudioLevel', 'SpeechCategoryAudioOut',
    'DISPID_SRSetPropertyNumber', 'SpeechAudioProperties',
    'SREHypothesis', 'SVSFIsFilename', 'DISPID_SpeechGrammarRules',
    'SBONone', 'DISPID_SRSAudioStatus', 'SPEI_SOUND_START',
    'SDTLexicalForm', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRCAudioInInterferenceStatus', 'SPAUDIOSTATE',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCRequestedUIType',
    'SP_VISEME_12', 'SPPS_Interjection', 'DISPID_SPRuleParent',
    'SpeechTokenValueCLSID', 'SRCS_Disabled', 'ISpeechAudioStatus',
    'DISPID_SGRSTPropertyValue', 'DISPID_SGRSTsCount',
    'SPAO_RETAIN_AUDIO', 'DISPID_SVEStreamEnd',
    'DISPID_SOTGetDescription', 'DISPID_SLRemovePronunciation',
    'SPSEMANTICFORMAT', 'ISpNotifyTranslator', 'SPCS_ENABLED',
    'SPSHORTCUTTYPE', 'DISPID_SRRTLength',
    'SpeechPropertyComplexResponseSpeed', 'SPGS_ENABLED',
    'DISPID_SPIProperties', 'DISPID_SLGenerationId',
    'SDA_One_Trailing_Space', 'SRSEIsSpeaking', 'SpeechTokenKeyFiles',
    'SPAUDIOSTATUS', 'DISPID_SLWLangId', 'SVSFParseSapi',
    'ISpeechPhraseRules', 'DISPID_SRCEAdaptation',
    'DISPID_SRCCreateResultFromMemory', 'SAFT16kHz16BitMono',
    'SpVoice', 'SAFT44kHz16BitStereo', '_SPAUDIOSTATE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPSHORTCUTPAIRLIST',
    'SpPhoneConverter', 'SVP_13', 'SECHighConfidence',
    'SPEI_HYPOTHESIS', 'SpeechAllElements', 'SPLO_DYNAMIC',
    'SPEI_END_SR_STREAM', 'DISPID_SRGState', 'SASRun',
    'DISPID_SPERequiredConfidence', 'ISpRecognizer',
    'DISPID_SPPFirstElement', 'eLEXTYPE_PRIVATE18',
    'SPINTERFERENCE_NOSIGNAL', 'SVP_17', 'STSF_CommonAppData',
    'SAFTCCITT_ALaw_44kHzMono', 'SAFT12kHz8BitStereo',
    'SpInprocRecognizer', 'DISPID_SBSSeek', '__MIDL_IWinTypes_0009',
    ...
    'tagSPPROPERTYINFO', 'SPDATAKEYLOCATION', 'DISPID_SVPriority',
    'SINoise', 'DISPID_SOTSetId', 'SFTInput', 'DISPIDSPRG',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCEAudioLevel',
    'SDTAlternates', 'DISPID_SRCState', 'SPEI_MIN_SR',
    'SpeechTokenContext', 'SPPS_Modifier', 'SAFT24kHz16BitStereo',
    'eLEXTYPE_APP', 'SpInProcRecoContext',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRSTWeight',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SVSPhonemeId', 'SVPOver',
    'ISpeechPhraseReplacement', 'DISPID_SVESentenceBoundary',
    'eWORDTYPE_ADDED', 'SPAR_Unknown', 'SPCT_SUB_DICTATION',
    'SpSharedRecognizer', 'SpLexicon', 'SpeechPartOfSpeech',
    'SPPS_LMA', 'SSTTTextBuffer', 'DISPID_SADefaultFormat',
    'DISPID_SPRText', 'DISPID_SPRuleConfidence', 'DISPID_SVEPhoneme',
    'SRTAutopause', 'SpeechGrammarTagWildcard',
    'SSSPTRelativeToStart', 'SPDKL_CurrentConfig',
    'DISPID_SPAPhraseInfo', 'SPSEMANTICERRORINFO', 'SREStreamStart',
    'SRERecognition', 'DISPID_SPEEngineConfidence',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPBO_PAUSE', 'SPEI_REQUEST_UI',
    'ISpEventSink', 'SRESoundStart', 'DISPID_SVResume',
    'SpeechPropertyAdaptationOn', 'SPPS_RESERVED1',
    'DISPID_SVEViseme', 'ISpeechPhraseProperties', 'DISPID_SRProfile',
    'SPWORDLIST', 'SBOPause', 'DISPID_SOTs_NewEnum', 'SP_VISEME_20',
    'SpeechRunState', 'DISPID_SGRsDynamic', 'SPINTERFERENCE',
    'DISPID_SpeechVoice', 'DISPID_SpeechRecoResult', 'SPFM_NUM_MODES',
    'ISpPhoneConverter', 'DISPID_SRCEEnginePrivate',
    'DISPID_SASNonBlockingIO', 'SpeechWordPronounceable',
    'SPSHT_OTHER', 'SPSNoun', 'SGRSTTTextBuffer',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_VENDORLEXICON',
    'eLEXTYPE_RESERVED7', 'SGRSTTEpsilon', 'SP_VISEME_6',
    'DISPID_SPRsItem', 'DISPID_SDKGetlongValue',
    'SAFT16kHz16BitStereo', 'DISPID_SDKEnumKeys', 'IEnumString',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SITooLoud',
    'SAFT48kHz8BitStereo', 'SAFTADPCM_44kHzStereo',
    'DISPID_SGRAddState', 'eLEXTYPE_PRIVATE2', 'DISPID_SPEsCount',
    'DISPID_SPIRule', 'DISPID_SpeechPhraseElements',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPPConfidence',
    'DISPID_SPRNumberOfElements', 'SITooFast', 'SPPHRASERULE',
    'ISpeechCustomStream', 'SpeechPropertyResponseSpeed',
    'SPPS_Function', 'DISPID_SASState', 'DISPID_SRCBookmark',
    'SpTextSelectionInformation', 'DISPID_SVSInputWordPosition',
    'DISPID_SCSBaseStream', 'DISPID_SMSGetData', 'ISpLexicon',
    'DISPID_SRRSpeakAudio', 'SPSHT_Unknown', 'DISPID_SLWsItem',
    'DISPID_SOTCDefault', 'SREInterference', 'SPEI_RESERVED5',
    'DISPID_SPELexicalForm', 'ISpPhoneticAlphabetConverter',
    'SAFTADPCM_11kHzStereo', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRGCommit', 'SRTSMLTimeout', 'SPLOADOPTIONS',
    'eLEXTYPE_USER_SHORTCUT', 'SVEViseme',
    'SpeechCategoryRecognizers', 'DISPID_SOTCSetId',
    'ISpRecoCategory', 'STSF_LocalAppData', 'SpeechGrammarState',
    'DISPID_SPIElements', 'SDKLLocalMachine',
    'DISPID_SRGCmdLoadFromFile', 'Speech_Default_Weight',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechXMLRecoResult',
    'SVPAlert', 'SpeechCategoryAudioIn', 'SAFT48kHz16BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPAR_Medium',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechPhraseReplacements',
    'SVSFVoiceMask', 'SPEI_SOUND_END', 'SAFT11kHz16BitStereo',
    'SRTEmulated', 'ISpeechRecoResult', 'SP_VISEME_19',
    'DISPID_SASFreeBufferSpace', 'DISPID_SGRSTransitions',
    'DISPID_SLPsItem', 'UINT_PTR', 'DISPID_SGRSTPropertyId',
    'SVEPrivate', 'SRAORetainAudio', 'SP_VISEME_21',
    'SPPS_SuppressWord', 'SpObjectToken', 'DISPID_SPPParent',
    'ISpeechXMLRecoResult', 'SDTRule', 'SGRSTTRule',
    ...
    'SSFMCreateForWrite', 'DISPID_SGRClear',
    'SGDSActiveUserDelimited', 'DISPID_SDKOpenKey', 'DISPID_SGRsItem',
    'DISPID_SpeechGrammarRuleState', 'SPLEXICONTYPE', 'SPPS_Noun',
    'SDTDisplayText', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPRS_INACTIVE', 'STCAll',
    'SSSPTRelativeToCurrentPosition', 'SRTExtendableParse',
    'DISPID_SpeechAudioFormat', 'SPFM_CREATE_ALWAYS', 'SPSMF_UPS',
    'SPPHRASE', 'DISPID_SpeechRecoResultTimes', 'DISPID_SPAsCount',
    'DISPID_SOTsCount', 'STSF_FlagCreate', 'DISPID_SpeechFileStream',
    'DISPID_SRGId', 'DISPID_SPPsItem', 'DISPID_SVPause',
    'DISPID_SGRsCommitAndSave', 'SPEI_VISEME', 'SAFT22kHz8BitStereo',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPWORDPRONOUNCEABLE',
    'SPSSuppressWord', 'DISPID_SOTMatchesAttributes',
    'SECNormalConfidence', 'SpStream', 'eLEXTYPE_PRIVATE9',
    '_RemotableHandle', 'DISPID_SAFSetWaveFormatEx',
    ...
    'SPGRAMMARWORDTYPE', 'ISpeechPhraseAlternates',
    'DISPID_SPACommit', 'eLEXTYPE_PRIVATE1', 'DISPID_SLWsCount',
    'ISpeechPhraseAlternate', 'ISpProperties', 'DISPID_SVEBookmark',
    'SVSFPurgeBeforeSpeak', 'SAFT32kHz16BitStereo',
    'DISPID_SGRsFindRule', 'SDA_No_Trailing_Space', 'SVP_12',
    'SGRSTTWildcard', 'SRCS_Enabled', 'SpeechLoadOption',
    'ISpRecognizer3', 'ISpeechPhoneConverter',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechBaseStream',
    'DISPID_SRRTStreamTime', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRRDiscardResultInfo', 'SVSFUnusedFlags',
    'SPEI_RECO_OTHER_CONTEXT', 'SPVISEMES', 'SVSFIsXML',
    'Speech_Max_Word_Length', 'DISPID_SGRSTText',
    'SPDKL_LocalMachine', 'SP_VISEME_3',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechFileStream',
    'SAFTDefault', 'SAFT16kHz8BitStereo', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SMSALineId', 'SECLowConfidence', 'SVP_0',
    'SpeechDictationTopicSpelling', 'SPRULE', 'DISPID_SPIEngineId',
    'SPXRO_Alternates_SML', 'DISPID_SRGRecoContext',
    'DISPID_SPRules_NewEnum', 'SVP_2', 'eLEXTYPE_RESERVED6',
    'SVEAudioLevel', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechPhraseRule', 'DISPID_SRCPause', 'SGDisplay',
    'SAFTGSM610_44kHzMono', 'SpeechLexiconType',
    'DISPID_SRCEInterference', 'DISPID_SWFESamplesPerSec',
    'SPBINARYGRAMMAR', 'SAFT11kHz16BitMono', 'SpFileStream',
    'ISpeechAudioBufferInfo', 'ISpeechPhraseReplacements',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SAVolume',
    'SPCT_DICTATION', 'DISPID_SRGDictationSetState', 'ISpeechLexicon',
    'SDKLCurrentConfig', 'ISpeechGrammarRuleStateTransition',
    'ISpeechDataKey', 'DISPID_SpeechCustomStream',
    'eLEXTYPE_PRIVATE7', 'DISPID_SLPSymbolic', 'DISPID_SGRsCount',
    'SVP_8', 'DISPID_SRCERecognizerStateChange', 'DISPID_SGRSTsItem',
    'SWTAdded', 'DISPID_SOTCategory', 'SPSModifier', 'SLODynamic',
    'DISPID_SRGCmdSetRuleIdState', 'SPSMF_SAPI_PROPERTIES',
    'SpSharedRecoContext', 'eLEXTYPE_PRIVATE8', 'SPSHORTCUTPAIR',
    'SpeechVoiceSpeakFlags', 'SPRST_NUM_STATES',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpCustomStream',
    'SPINTERFERENCE_NONE', 'ISpNotifySink', 'SAFT16kHz8BitMono',
    'DISPID_SGRs_NewEnum', 'SPEI_PHONEME', 'SDTReplacement',
    'DISPID_SRCEEndStream', 'SDA_Two_Trailing_Spaces', 'SVP_20',
    'SPTEXTSELECTIONINFO', 'DISPID_SPRulesItem',
    'DISPID_SRRAlternates', 'SVP_3', 'SFTSREngine',
    'SpeechPropertyHighConfidenceThreshold', 'SpNullPhoneConverter',
    'DISPID_SLGetGenerationChange', 'SECFEmulateResult', 'SPAS_STOP',
    'SP_VISEME_7', 'SPWT_LEXICAL', 'DISPID_SpeechPhraseElement',
    'SREFalseRecognition', 'SpeechRegistryUserRoot',
    'SpeechRetainedAudioOptions', 'SGDSActive', 'SPFM_OPEN_READONLY',
    'SAFT32kHz16BitMono', 'SAFT24kHz8BitMono', 'DISPID_SPAs_NewEnum',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPPId', 'SAFT48kHz8BitMono',
    'STCRemoteServer', 'DISPID_SRRTimes',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPCIdToPhone',
    'SPEI_SENTENCE_BOUNDARY', 'SPCT_COMMAND', 'SPSERIALIZEDPHRASE',
    'SPPARTOFSPEECH', 'DISPID_SPEActualConfidence',
    ...
    'DISPID_SVEAudioLevel', 'SVP_5', 'DISPID_SRCESoundStart',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SLPPhoneIds',
    'eWORDTYPE_DELETED', 'SP_VISEME_14', 'SpeechGrammarTagDictation',
    'DISPID_SpeechRecoContextEvents', 'SpeechWordType',
    'SpeechTokenShellFolder', 'SVESentenceBoundary',
    'DISPID_SRGSetTextSelection', 'SPAS_CLOSED', 'SPSNotOverriden',
    'ISpeechRecoGrammar', 'SpeechDisplayAttributes',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRSSupportedLanguages',
    'SPVOICESTATUS', 'SPEVENT', 'eLEXTYPE_RESERVED9',
    'SpeechAudioFormatGUIDText', 'SPSUnknown',
    'DISPID_SRGCmdLoadFromResource', 'ISpShortcut', 'DISPID_SPPName',
    'SPEI_TTS_PRIVATE', 'SAFTCCITT_uLaw_44kHzStereo', 'SP_VISEME_2',
    'DISPID_SDKSetStringValue', 'ISpNotifySource',
    ...
    'SPCT_SUB_COMMAND', 'SpeechAddRemoveWord',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SLPLangId',
    'DISPID_SDKEnumValues', 'SPEI_MAX_SR', 'DISPID_SGRInitialState',
    'SP_VISEME_1', 'DISPID_SpeechPhraseBuilder', 'SREStreamEnd',
    'DISPID_SWFEBitsPerSample', 'DISPID_SDKSetLongValue',
    'DISPID_SPRuleNumberOfElements', 'SASPause',
    'SAFTCCITT_ALaw_22kHzMono', 'SVP_16', 'eLEXTYPE_PRIVATE15',
    'ISpeechMemoryStream', 'SPBO_NONE', 'SREAdaptation',
    'SP_VISEME_15', 'ISpeechGrammarRule', 'STCInprocServer',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVVolume',
    'DISPID_SpeechRecognizer', 'DISPID_SOTCreateInstance',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_PRIVATE14',
    'SAFT11kHz8BitMono', 'IEnumSpObjectTokens',
    'DISPID_SWFEBlockAlign', 'DISPID_SVAudioOutput', 'SVP_21',
    'eLEXTYPE_PRIVATE3', 'SAFTText', 'SREAllEvents',
    'DISPID_SPRDisplayAttributes', 'SpMMAudioOut', 'SVEVoiceChange',
    'eLEXTYPE_PRIVATE13', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SLPPartOfSpeech', 'SSFMOpenForRead', 'SRSEDone',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVSFIsNotXML',
    'DISPID_SLAddPronunciation', 'ISpStreamFormat', 'SPWORDTYPE',
    'DISPID_SOTDisplayUI', 'DISPID_SOTRemove', 'SPPS_RESERVED3',
    ...
    'SpeechCategoryVoices', 'DISPID_SVSkip', 'SECFIgnoreCase',
    'SPWORD', 'ISpRecoContext2', 'SVP_6', 'SVSFParseSsml',
    'SpCompressedLexicon', 'DISPID_SPRs_NewEnum',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SGRId', 'SVF_Stressed',
    'DISPID_SOTCId', 'DISPID_SPILanguageId', 'SWTDeleted',
    'SGSExclusive', 'SPAR_Low', 'DISPID_SRRAudioFormat',
    'DISPID_SpeechPhraseProperty', 'SSFMCreate', 'SP_VISEME_17',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechRecognizerStatus', 'SASStop',
    'SpPhoneticAlphabetConverter', 'DISPID_SPEPronunciation',
    'SPSERIALIZEDRESULT', 'SpWaveFormatEx', 'SAFTNoAssignedFormat',
    'SPRST_INACTIVE', 'SP_VISEME_5', 'DISPID_SPEDisplayText',
    'DISPID_SDKSetBinaryValue', 'DISPID_SpeechWaveFormatEx',
    'SPAUDIOOPTIONS', 'SSTTDictation', 'DISPID_SRCEBookmark',
    'ISpRecoGrammar2', 'SPCATEGORYTYPE', 'ISpObjectTokenCategory',
    'SpeechAudioState', 'SITooQuiet', 'SPVPRI_OVER',
    'DISPID_SpeechObjectTokens', 'SAFT24kHz16BitMono', 'DISPIDSPTSI',
    'ISpeechBaseStream', 'DISPID_SVGetAudioOutputs',
    'SVEEndInputStream', 'SRAExport', 'DISPID_SPIStartTime',
    'SAFT8kHz8BitStereo', 'DISPID_SWFEAvgBytesPerSec',
    'SPRECOGNIZERSTATUS', 'DISPID_SRCSetAdaptationData', 'SGSEnabled',
    'SPEI_SR_PRIVATE', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SPRuleChildren', 'SpeechCategoryPhoneConverters',
    'ISpAudio', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_PHRASE_START',
    'SAFT32kHz8BitStereo', 'STCInprocHandler',
    'DISPID_SRRSaveToMemory', 'ISpeechLexiconWords',
    'SAFT8kHz16BitStereo', 'SpeechInterference', 'SVP_9', 'ISpVoice',
    'SpShortcut', 'SPCS_DISABLED', 'ISpeechVoice',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechEmulationCompareFlags',
    'SpeechRecognizerState', 'SPFM_OPEN_READWRITE', 'ISpPhraseAlt',
    'DISPID_SVDisplayUI', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPPS_Noncontent', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SLAddPronunciationByPhoneIds', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPCLangId', 'SPEVENTENUM', 'SPEI_RESERVED6',
    'SVSFNLPMask', 'SP_VISEME_0',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SMSSetData',
    'DISPID_SGRName', 'DISPID_SOTCEnumerateTokens', 'DISPID_SAFGuid',
    ...
    'SPSTREAMFORMATTYPE', 'SVEBookmark', 'DISPID_SVEWord',
    'SpeechCategoryRecoProfiles', 'SPPS_NotOverriden',
    'SpeechBookmarkOptions', 'DISPID_SpeechVoiceEvent',
    'DISPID_SLWType', 'SPAR_High', 'ISpeechAudioFormat',
    'ISpObjectWithToken', 'SLOStatic', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'ISpRecoGrammar', 'SPVPRI_ALERT', 'SVP_11', 'DISPID_SABufferInfo',
    'SRAONone', 'SP_VISEME_16', 'SGLexicalNoSpecialChars',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SpeechRecoResult2',
    'ISpeechPhraseElement', 'DISPID_SVRate',
    'DISPID_SRCCmdMaxAlternates', 'SRSActive',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SLPsCount', 'SVP_18',
    'DISPID_SRGRules', 'SPWT_PRONUNCIATION', 'SVSFPersistXML',
    'ISpEventSource', 'SAFTADPCM_8kHzMono', 'DISPID_SRCERecognition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SVEWordBoundary', 'DISPID_SPAStartElementInResult',
    'ISpeechRecoResult2', 'SPFILEMODE', 'SECFNoSpecialChars',
    ...
    'SPEI_TTS_BOOKMARK', 'DISPID_SRRAudio', 'ISpSerializeState',
    'DISPID_SpeechLexiconProns', 'STSF_AppData', 'SPPHRASEPROPERTY',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SMSADeviceId',
    'DISPID_SpeechGrammarRule', 'DISPID_SPISaveToMemory',
    'ISpXMLRecoResult', 'SREPropertyNumChange', 'DISPID_SGRsAdd',
    'SPEI_START_INPUT_STREAM', 'ISpeechTextSelectionInformation',
    'ISpeechRecoContext', 'STCLocalServer', 'SpeechVoiceEvents',
    'SPPS_RESERVED4', 'SPAS_PAUSE', 'SAFTExtendedAudioFormat',
    'SAFT8kHz8BitMono', 'DISPID_SPIAudioSizeBytes',
    'SPBOOKMARKOPTIONS', 'DISPID_SLWPronunciations',
    'DISPID_SRGCmdLoadFromMemory', 'SPBO_AHEAD',
    'SpeechEngineProperties', 'SPVPRIORITY', 'SRTStandard',
    'SpeechSpecialTransitionType', 'ISpeechRecoResultDispatch',
    'SVSFParseMask', 'DISPID_SpeechAudioStatus', 'SGSDisabled',
    'DISPID_SPANumberOfElementsInResult', 'ISpRecognizer2',
    'DISPIDSPTSI_ActiveOffset', 'SPRST_INACTIVE_WITH_PURGE',
    'SP_VISEME_18', 'DISPID_SDKGetBinaryValue', 'DISPID_SRCVoice',
    'SVSFParseAutodetect', 'DISPID_SFSClose', 'SRTReSent',
    'DISPID_SBSWrite', 'DISPID_SRState', 'DISPID_SGRSRule',
    'SECFIgnoreWidth', 'SpeechRuleState',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRRGetXMLErrorInfo', 'ISpDataKey',
    'DISPID_SPERetainedStreamOffset', 'SECFDefault', 'SPGS_DISABLED',
    'SPDKL_CurrentUser', 'DISPID_SAFGetWaveFormatEx',
    'ISpeechLexiconWord', 'SP_VISEME_11', 'SpMemoryStream',
    'SVPNormal', 'SVP_4', 'ISpPhoneticAlphabetSelection',
    'DISPID_SASCurrentDevicePosition', 'SpeechRecoEvents',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SITooSlow',
    ...
    'ISpStreamFormatConverter', 'SPWF_SRENGINE',
    'SPEI_SR_AUDIO_LEVEL', 'LONG_PTR', 'DISPID_SBSRead',
    'SPEI_RECOGNITION', 'DISPID_SRAudioInput',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechPhraseRules',
    'SRATopLevel', 'SpeechRuleAttributes',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRStatus', 'SSTTWildcard',
    'SGDSInactive', 'DISPID_SPRuleFirstElement', 'SINoSignal',
    'DISPID_SRIsShared', 'DISPID_SpeechPhraseInfo',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SAFType',
    'SAFTGSM610_22kHzMono', 'SVF_None', 'SpUnCompressedLexicon',
    'ISpeechLexiconPronunciation', 'DISPID_SDKCreateKey',
    'SWPUnknownWordPronounceable', 'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechMemoryStream',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPRuleId',
    'SpNotifyTranslator', 'ISpeechMMSysAudio', 'SPEI_RESERVED2'
]

_check_version('1.1.14', 1626696761.256600)
